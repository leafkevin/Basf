...
namespace Basf.Orm
{
    public static class DapperExtension
    {
        ...
        #region 方法
        //public static TEntity Read<TEntity>(this IDbConnection connection, object condition, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    string tableName = GetTableName(entityType);
        //    List<string> whereList = GetColumnNameList(entityType, condition);
        //    string wheres = String.Join(" AND ", whereList.Select(p => OrmProvider.ColumnNameFor(p) + "=" + OrmProvider.ParamPrefix + p));
        ...
        //}
        //public static Task<TEntity> ReadAsync<TEntity>(this IDbConnection connection, object condition, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    string tableName = GetTableName(entityType);
        //    List<string> whereList = GetColumnNameList(entityType, condition);
        //    string wheres = String.Join(" AND ", whereList.Select(p => OrmProvider.ColumnNameFor(p) + "=" + OrmProvider.ParamPrefix + p));
        //    string sql = String.Format("SELECT * FROM {0} WHERE {1}", tableName, wheres);
        //    return connection.ReadAsync<TEntity>(sql, condition, transaction, OrmProvider.CommandTimeout);
        //}
        //public static int Create<TEntity>(this IDbConnection connection, dynamic data, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    object obj = data as object;
        //    string tableName = GetTableName(entityType);
        //    List<string> columnList = GetColumnNameList(entityType, obj);
        //    string columns = String.Join(",", columnList.Select(p => OrmProvider.ColumnNameFor(p)));
        ...
        //}
        //public static Task<int> CreateAsync<TEntity>(this IDbConnection connection, dynamic data, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    object obj = data as object;
        //    string tableName = GetTableName(entityType);
        ...
        //}
        //public static IEnumerable<TEntity> Query<TEntity>(this IDbConnection connection, object condition, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    string tableName = GetTableName(entityType);
        //    List<string> whereList = GetColumnNameList(entityType, condition);
        ...
        //}
        //public static Task<IEnumerable<TEntity>> QueryAsync<TEntity>(this IDbConnection connection, object condition, IDbTransaction transaction = null) where TEntity : class
        //{
        //    Type entityType = typeof(TEntity);
        //    string tableName = GetTableName(entityType);
        //    List<string> whereList = GetColumnNameList(entityType, condition);
        ...
        internal static List<string> GetColumnNameList(Type entityType, object objData)
        {
            ...
            return objType.GetProperties(BindingFlags.Instance | BindingFlags.GetProperty | BindingFlags.Public)
                .Where(p => !p.IsDefined(typeof(IgnoreAttribute)) && columnList.Contains(p.Name)).Select(p => p.Name).ToList();
        }
        #endregion
    }
}